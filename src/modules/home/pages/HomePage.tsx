            ...
            tooltip: {
              ...
              callbacks: {
                label: function (context: TooltipItem<'bar'>) {
                  ...
                  return `${context.parsed.y} personas (${percentage}%)`;
                },
              },
            },
          },
          ...
          datasets: [
            {
              ...
              backgroundColor: [
                ...
                'rgba(231, 76, 60, 0.85)',    // Danger
                'rgba(155, 89, 182, 0.85)',   // Purple
                'rgba(52, 73, 94, 0.85)',     // Secondary
          ...
          <Card elevation={2} sx={{ p: 2, borderRadius: 2, height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            <Box sx={{
              ...
              <Typography variant="body2" color="text.secondary" sx={{ maxWidth: '80%' }}>
                Las métricas de desempeño estarán disponibles una vez que completes tu primera evaluación.
              </Typography>
            </Box>
          </Card>
        );
        ...
        return (
          <Card elevation={2} sx={{ p: 2, borderRadius: 2, height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            <Box sx={{
              ...
              <Typography variant="body2" color="text.secondary" sx={{ maxWidth: '80%' }}>
                Tu historial de actividades aparecerá aquí. Por ahora, puedes revisar tus notificaciones.
              </Typography>
              <Button
                variant="outlined"
                color="primary"
