...
const AVAILABLE_STATUSES = 'CHECKOUT_SECURITY';
const MINE_STATUSES = 'CHECKOUT_OPS';
const DONE_STATUSES = 'DISPATCHED';

const STATUS_LABELS: Record<string, string> = {
    CHECKOUT_SECURITY: 'Listo para ops',
    CHECKOUT_OPS: 'Validado ops',
};
                    ...
                    {!activeData.loading && activeData.items.length === 0 && (
                        <Box sx={{ textAlign: 'center', py: 8 }}>
                            ...
                            <Typography variant="body1" color="text.secondary">
                                {tab === 0 && 'No hay pautas esperando validación de operaciones.'}
                                {tab === 1 && 'No tienes pautas validadas por operaciones.'}
                                {tab === 2 && 'Aún no hay pautas despachadas hoy.'}
                            </Typography>
                    ...
                    {!activeData.loading && activeData.items.length > 0 && (
                        tab === 2 ? (
                            ...
                            <BayMapView
                                ...
                                emptyMessage={
                                    tab === 0
                                        ? 'No hay pautas esperando validación de operaciones.'
                                        : 'No tienes pautas validadas por operaciones.'
                                }
