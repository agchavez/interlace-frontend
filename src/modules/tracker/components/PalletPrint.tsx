...
const PalletPrintContent: FunctionComponent<PalletPrintContentProps> = ({
  pallet,
}) => {
        ...
        >
          ...
          <Grid item xs={12} container padding="3pt">
            ...
            <Grid item xs={8} sx={{ textAlign: "center" }} margin="auto">
              <Grid item>
                <Typography fontSize={18}>Origen: {pallet?.origen}</Typography>
          ...
          >
            <Typography fontSize={35}>
              {pallet?.nombre_producto.slice(0, 23)}
            </Typography>
          </Grid>
          <Grid item xs={12} container sx={{ textAlign: "center" }}>
            ...
            <Grid item xs={7} container>
              <Grid item xs={4} container direction="column" margin="auto">
                <Typography fontSize={13}># PALLETS INGRESADOS</Typography>
              ...
              >
                <Typography fontSize={15}>
                  {/* 
                                    ...
                                    */}
                  {format(new Date(), "HH:mm:ss") > "06:00:00" &&
                  format(new Date(), "HH:mm:ss") < "14:00:00"
                    ? "TA"
                    : format(new Date(), "HH:mm:ss") > "14:00:00" &&
                      format(new Date(), "HH:mm:ss") < "20:30:00"
                    ? "TB"
                    : format(new Date(), "HH:mm:ss") > "20:30:00" &&
                      format(new Date(), "HH:mm:ss") < "23:59:59"
                    ? "TC"
                    : format(new Date(), "HH:mm:ss") > "00:00:00" &&
                      format(new Date(), "HH:mm:ss") < "06:00:00"
                    ? "TC"
                    : ""}
                </Typography>
            ...
            <Grid item xs={6}>
              <Typography fontSize={30} textAlign="center" fontWeight={700}>
                {/* 
                                ...
                                */}
                {format(
                  subDays(parsedDate, pallet?.pre_block || 0),
                  "dd-MMM-yyyy",
                  { locale: es }
                ).toUpperCase()}
              </Typography>
            ...
            <Grid item xs={6}>
              <Typography fontSize={30} textAlign="center" fontWeight={700}>
                {/*
                                ...
                                */}
                {format(
                  subDays(parsedDate, pallet?.block || 0),
                  "dd-MMM-yyyy",
                  { locale: es }
                ).toUpperCase()}
              </Typography>
          ...
          <Grid container xs={12} marginTop="7pt" marginBottom="10pt">
            ...
            >
              <QRCodeSVG
                value={`${
                  import.meta.env.VITE_JS_FRONTEND_URL
                }/tracker/pallet-detail/${
                  pallet?.detalle_pallet_id
