            ...
            <Grid container spacing={2} sx={{ marginTop: 2, marginBottom: 5 }}>
                ...
                <Grid item xs={12} md={6} sx={{ marginTop: 1 }}>
                    ...
                    <Grid container spacing={2} sx={{ marginTop: 2 }}>
                        ...
                        <Grid item xs={12} md={6}>
                            <Button variant="outlined" size="small" fullWidth color="success" disabled={(tiempoEntrada !== null) ? true : false}
                                onClick={() => {
                        ...
                        <Grid item xs={12} md={6}>
                            <Button variant="outlined" size="small" fullWidth color="error" disabled={(tiempoEntrada !== null) && (tiempoSalida !== null)}
                                onClick={() => {
