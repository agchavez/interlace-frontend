...
export const OutPutDetail: FC<OutPutDetailProps> = ({ seguimiento, disable, outputType }) => {
    ...
    const tableContain = outputTypeDataToShow.find(ot=> ot.name.toUpperCase() === outputType.name)
